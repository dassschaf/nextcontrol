...
export const Sentences = {
    ...
    admin : {
        ...
        settingsSaved: info + 'Successfully saved settings.',
        settingsRead: info + 'Successfully read settings.',
        settingsReset: info + 'Successfully reset settings.',
        settingsSet: info + 'Successfully changed a setting.',
        settingsKept: info + 'Settings will not be reset to default at map change.',
    ...
    jukebox : {
        ...
        requiresList: warning + 'To jukebox a map, first use $i/list maps$i to get a number of tracks you can jukebox.',
        requiresId: warning + 'To jukebox a map, you must specify the number of the desired track from your recent map list.',
        invalidNumber: warning + 'Invalid map number.',
        invalidIndex: warning + 'Invalid map number: You can only jukebox tracks from $ff0#%lo%$fff to $ff0#%hi%$fff with your current map list.'
    },
