...
export const Sentences = {
    ...
    admin : {
        ...
        forceMod: {
            applied: priv + 'Mod successfully applied, changes will be visible starting with the next track.',
            reset: priv + 'Default mods will be displayed again starting with next track',
